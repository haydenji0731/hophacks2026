...
Chrome extension that watches **Discord**, **Instagram**, and **Reddit** locally and highlights **suspicious** user text. Normal chat stays untouched.
...
The toolbar has a Light / Dark switch. It restyles the popup, hover cards, Block gate, and highlight ink.
...
**Report a scam** sits in the toolbar, on hover cards, and on the Block gate. It opens [yourprinceisnotreal.net](http://yourprinceisnotreal.net/) and, after the homepage intro animation, scrolls to the report form.
...
| `report-scroll.js` | After the YPINR intro, scrolls to the homepage report form |
